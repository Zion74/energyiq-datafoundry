...
describe("Project Renderer Registry", () => {
  ...
  it("routes Ngee Ann and Preschool to independent Snapshot Renderers", () => {
    ...
    expect(preschoolMarkup).toContain("L · E · N need after-hours checks first");
    expect(preschoolMarkup).toContain("G · M · J need metadata and Appliance review first");
    expect(preschoolMarkup).toContain("14 Centres need operating-hour event review");
