...
const autonomousInvestigationCompletionPolicy = "If another query is unlikely to materially change the conclusion, action, or uncertainty, finalize the answer. This is the Agent's evidence judgment, not a query quota.";
...
const ngeeAnnAnalysisPolicy = (context: EnergyQueryContext): string[] =>
  context.projectId === "ngee-ann-polytechnic"
    ? [
        ...
        autonomousInvestigationCompletionPolicy,
