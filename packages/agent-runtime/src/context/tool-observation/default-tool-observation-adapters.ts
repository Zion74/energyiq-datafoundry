...
import {
  ...
  OverviewAiCandidateSubmissionToolObservationAdapter
} from "./adapters/protocol-tool-observation-adapters.js";
...
const defaultToolObservationAdapters = (
  ...
  new OverviewAiCandidateSubmissionToolObservationAdapter(),
