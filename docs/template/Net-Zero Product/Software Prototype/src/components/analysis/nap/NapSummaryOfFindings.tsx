...
interface NapSummaryOfFindingsProps {
  sections: NapFindingSection[];
}

export function NapSummaryOfFindings({ sections }: NapSummaryOfFindingsProps) {
  return (
    <section className="panel p-4">
      <div className="mb-4 flex items-center justify-between gap-3">
        <RequirementGuideTitle
          ...
          content={{
            title: "Summary of Findings",
            summary: "Structured insights grouped by theme, generated from the NAP Level 6 & 7 monitoring dataset.",
            dataAcquisition: [
              "Derived from aggregate and sub-meter readings for 19 May–17 Jun 2026.",
              "Anomaly baseline uses day-type means from 21 Apr–17 Jun 2026.",
              "Grouped into scope, levels, categories, day-type behaviour, peaks, and anomalies."
            ],
            chartGeneration: [
